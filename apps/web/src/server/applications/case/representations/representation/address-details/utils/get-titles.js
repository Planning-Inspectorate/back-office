...
const getRepresentedTitles = (repMode) => {
	let representedTitles = mapTitles('Address details', 'Address details');

	if (repMode === 'change')
		representedTitles = mapTitles('Change address details', 'Change address details');
...
const getRepresentativeTitles = (repMode) => {
	...
	if (repMode === 'change')
		representativeTitles = mapTitles(
			'Change agent address details',
			'Change agent address details'
		);
