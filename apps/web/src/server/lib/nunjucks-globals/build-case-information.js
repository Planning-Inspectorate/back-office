...
export const buildCaseInformation = (params, isWelsh) => [
    ...
    ...(params.keyMembers?.caseManager ? [{ title: 'Case manager', text: params.keyMembers.caseManager }] : []),
    ...
    {
        title: featureFlagClient.isFeatureActive('applic-55-welsh-translation') ? 'Regions' : 'Region(s)',
