...
When("the user enters geographical information for the new case", function () {
	...
	createCasePage.sections.geographicalInformation.fillLocation(
...
When(
	"the user enters the case team email address for the new case",
	function () {
...
When(
	"the user enters the applicant's organisation name for the new case",
	function () {
...
When(
	"the user enters the applicant's first and last name for the new case",
	function () {
...
When(
	"the user enters the applicant's phone number for the new case",
	function () {
