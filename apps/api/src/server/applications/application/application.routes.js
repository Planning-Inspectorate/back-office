...
router.get(
	...
	/*
		...
		#swagger.parameters['query'] = {
            in: 'query',
            description: 'Application details',
			example: '\{ &ldquo;title&rdquo;\:true, &ldquo;description&rdquo;\:true\, &ldquo;reference&rdquo;\:true, &ldquo;status&rdquo;\:true, &ldquo;caseEmail&rdquo;\:true, &ldquo;sector&rdquo;\:true, &ldquo;subSector&rdquo;\:true, &ldquo;applicant&rdquo;\:true, &ldquo;geographicalInformation&rdquo;\:true, &ldquo;keyDates&rdquo;\:true, &ldquo;isMaterialChange&rdquo;\:true \}',
    	}
		#swagger.parameters['x-service-name'] = {
			in: 'header',
			type: 'string',
