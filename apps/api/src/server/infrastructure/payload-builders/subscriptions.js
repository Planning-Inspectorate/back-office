...
export function buildSubscriptionBasePayload(subscription) {
	...
	const payload = {
		...
		emailAddress: subscription.subscriber.email,
 ...
 *
 * @param {import('@pins/applications.api').Schema.Subscription} existingSub
 * @param {import('@pins/applications.api').Schema.Subscription} newSub
