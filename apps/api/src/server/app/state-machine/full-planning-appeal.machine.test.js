...
import { transitionState } from './full-planning-appeal.machine.js';
...
applyAction.title = (providedTitle = '', initial_state, action, expected_state, has_changed, context) =>
	`Full Planning Appeal State Machine: ${providedTitle}: from state [${JSON.stringify(initial_state)}] with context ${JSON.stringify(context)} action [${action}] produces state
...
for (const parameter of [
	...
	[buildCompoundState('awaiting_lpa_questionnaire', 'available_for_statements'), 'INVALID', buildCompoundState('awaiting_lpa_questionnaire', 'available_for_statements'), false, { appealId: 1 }],
	[buildCompoundState('awaiting_lpa_questionnaire', 'available_for_statements'), 'OVERDUE', buildCompoundState('overdue_lpa_questionnaire', 'available_for_statements'), true, { appealId: 1 }],
	[buildCompoundState('awaiting_lpa_questionnaire', 'available_for_statements'), 'RECEIVED', buildCompoundState('received_lpa_questionnaire', 'available_for_statements'), true, { appealId: 1 }],
	[buildCompoundState('overdue_lpa_questionnaire', 'available_for_statements'), 'RECEIVED', buildCompoundState('received_lpa_questionnaire', 'available_for_statements'), true, { appealId: 1 }],
	[buildCompoundState('overdue_lpa_questionnaire', 'available_for_statements'), 'COMPLETE', buildCompoundState('overdue_lpa_questionnaire', 'available_for_statements'), false, { appealId: 1 }],
	[buildCompoundState('overdue_lpa_questionnaire', 'available_for_statements'), 'INCOMPLETE', buildCompoundState('overdue_lpa_questionnaire', 'available_for_statements'), false, { appealId: 1 }],
	[buildCompoundState('received_lpa_questionnaire', 'available_for_statements'), 'COMPLETE', buildCompoundState('available_for_inspector_pickup', 'available_for_statements'), true, { appealId: 1 }],
	[buildCompoundState('received_lpa_questionnaire', 'available_for_statements'), 'INCOMPLETE', buildCompoundState('incomplete_lpa_questionnaire', 'available_for_statements'), true, { appealId: 1 }],
	[buildCompoundState('incomplete_lpa_questionnaire', 'available_for_statements'), 'COMPLETE', buildCompoundState('available_for_inspector_pickup', 'available_for_statements'), true, { appealId: 1 }],
	[buildCompoundState('available_for_inspector_pickup', 'available_for_statements'), 'PICKUP', buildCompoundState('picked_up', 'available_for_statements'), true, { appealId: 1 }],
	[buildCompoundState('picked_up', 'available_for_statements'), 'BOOK', buildCompoundState('picked_up', 'available_for_statements'), false, { appealId: 1, inspectionType: 'accompanied' }],
    [buildCompoundState('awaiting_lpa_questionnaire', 'available_for_statements'), 'RECEIVED_STATEMENTS', buildCompoundState('awaiting_lpa_questionnaire', 'available_for_final_comments'), true, { appealId: 1 }],
    [buildCompoundState('awaiting_lpa_questionnaire', 'available_for_statements'), 'DID_NOT_RECEIVE_STATEMENTS', buildCompoundState('awaiting_lpa_questionnaire', 'closed_for_statements_and_final_comments'), true, { appealId: 1 }],
    [buildCompoundState('awaiting_lpa_questionnaire', 'available_for_final_comments'), 'RECEIVED_FINAL_COMMENTS', buildCompoundState('awaiting_lpa_questionnaire', 'closed_for_statements_and_final_comments'), true, { appealId: 1 }],
    [buildCompoundState('available_for_inspector_pickup', 'closed_for_statements_and_final_comments'), 'PICKUP', 'site_visit_not_yet_booked', true, { appealId: 1 }],
    [buildCompoundState('picked_up', 'available_for_final_comments'), 'RECEIVED_FINAL_COMMENTS', 'site_visit_not_yet_booked', true, { appealId: 1 }],
