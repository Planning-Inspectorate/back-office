...
for (const parameter of [
	...
	['awaiting_statements', 'INCOMPLETE', 'awaiting_statements', false, { appealId: 1 }],
	['awaiting_statements', 'COMPLETE', 'received_statements', true, { appealId: 1 }],
	['received_statements', 'INCOMPLETE', 'received_statements', false, { appealId: 1 }],
	['awaiting_final_comments', 'INCOMPLETE', 'awaiting_final_comments', false, { appealId: 1 }],
	['awaiting_comments', 'INCOMPLETE', 'awaiting_comments', false, { appealId: 1 }],
