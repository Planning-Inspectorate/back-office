...
-- AddForeignKey
ALTER TABLE [dbo].[Document] ADD CONSTRAINT [Document_metadataId_fkey] FOREIGN KEY ([metadataId]) REFERENCES [dbo].[DocumentVersion]([id]) ON DELETE SET NULL ON UPDATE CASCADE;
