Feature: Create New Case journey as an Case Admin user
	...
	Scenario: Case Admins should be able to create a new case
		...
		When the user chooses the sector and subsector for the case
		...
		And the user enters the internal anticipated submission date
		And the user clicks the "Save and continue" button
		Then the user should successfully verify the answers on the summary page against form inputs
