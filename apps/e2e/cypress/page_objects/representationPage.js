...
export class RepresentationPage extends Page {
	...
	elements = {
		...
		preexmaninationToggle:()=>cy.get('div.govuk-accordion__section:nth-child(4) > div:nth-child(1) > h2:nth-child(1) > button:nth-child(1) > span:nth-child(3) > span:nth-child(1) > span:nth-child(2)'),
        manageDate:()=>cy.get('#accordion-key-dates-content-3 > div:nth-child(1) > a:nth-child(1)'),
		repDay:()=>cy.get('body > div:nth-child(4) > main:nth-child(2) > form:nth-child(2) > div:nth-child(2) > fieldset:nth-child(1) > div:nth-child(3) > div:nth-child(1) > div:nth-child(1) > input:nth-child(2)'),
		repMonth:()=>cy.get('body > div:nth-child(4) > main:nth-child(2) > form:nth-child(2) > div:nth-child(2) > fieldset:nth-child(1) > div:nth-child(3) > div:nth-child(1) > div:nth-child(2) > input:nth-child(2)'),
		repYear:()=>cy.get('body > div:nth-child(4) > main:nth-child(2) > form:nth-child(2) > div:nth-child(2) > fieldset:nth-child(1) > div:nth-child(3) > div:nth-child(1) > div:nth-child(3) > input:nth-child(2)'),
