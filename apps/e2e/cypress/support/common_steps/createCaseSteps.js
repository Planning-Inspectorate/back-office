...
When(/^the user chooses the "([^"]*)" sector option$/, function (sectorOption) {
...
When(/^the user chooses the "([^"]*)" subsector option$/, function (subsectorOption) {
...
When(
	/^the user chooses all the available options for applicant information available$/,
	function () {
