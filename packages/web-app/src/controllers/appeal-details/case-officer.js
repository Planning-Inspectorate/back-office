...
const { saveAppealData, saveAppealLinkData, saveAppealSubmissionData} = require('../../lib/api-wrapper');
...
exports.getCaseOfficerDetails = (req, res) => {
  const {
    session: {
      appeal: { caseOfficerFirstName, caseOfficerEmail },
    },
  } = req;
...
exports.postCaseOfficerDetails = async (req, res) => {
  ...
  const casework = {
    [hasAppeal.caseOfficerFirstName]: newCaseOfficerName,
