        ...
        BEGIN
            ...
            BEGIN
                ...
                BEGIN
                    ...
                    WHERE [AppealID] = @AppealID
                    AND [CheckSumRow] = CHECKSUM(@AppealID,
                        CASE WHEN JSON_VALUE(@Data,'$.horizonId')='' THEN NULL ELSE JSON_VALUE(@Data,'$.appeal.horizonId') END,
                        CASE WHEN JSON_VALUE(@Data,'$.aboutYouSection.yourDetails.name')='' THEN NULL ELSE JSON_VALUE(@Data,'$.aboutYouSection.yourDetails.name') END,
                ...
                BEGIN
                    ...
                    BEGIN
                        ...
                        AND [CheckSumRow] = CHECKSUM(                  
                            ...
                            @AppealID,
                            CASE WHEN JSON_VALUE(@Data,'$.submissionDate')='' THEN NULL ELSE JSON_VALUE(@Data,'$.reply.submissionDate') END,
