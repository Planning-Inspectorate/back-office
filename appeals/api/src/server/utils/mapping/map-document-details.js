...
/** @typedef {import('appeals/api/src/database/schema.js').DocumentVersionWithDocument} DocumentVersionWithDocument */
/** @typedef {import('appeals/api/src/database/schema.js').DocumentWithSubTables} Document */
/** @typedef {import('appeals/api/src/database/schema.js').DocumentDetails} DocumentDetails */
