...
interface RepositoryGetByIdResultItem {
	address?: import('@pins/appeals.api').Schema.Address | null;
	appealDetailsFromAppellant?: import('@pins/appeals.api').Schema.AppealDetailsFromAppellant | null;
	appealStatus: { status: string; subStateMachineName: string | null }[];
	...
	startedAt: Date | null;
	lpaQuestionnaire?: import('@pins/appeals.api').Schema.LPAQuestionnaire;
}
