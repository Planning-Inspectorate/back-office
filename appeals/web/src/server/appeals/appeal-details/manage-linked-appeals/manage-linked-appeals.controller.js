...
export const postAddLinkedAppeal = async (request, response) => {
	...
	return response.redirect(`/appeals-service/appeal-details/${appealId}/linked-appeals/add/check-and-confirm`);
};
	...
	try {
		...
		if (unlinkAppeal === 'no') {
			return response.redirect(
				`/appeals-service/appeal-details/${appealId}/linked-appeals/manage`
			);
		}
		if (unlinkAppeal === 'yes') {
