import * as controller from '@pins/appeals.web/src/server/applications/case/applications-case.controller.js';
import * as locals from '@pins/appeals.web/src/server/applications/case/applications-case.locals.js';
import applicationsDocumentationRouter from '@pins/appeals.web/src/server/applications/case/documentation/applications-documentation.router.js';
import applicationsDocumentationMetadataRouter from '@pins/appeals.web/src/server/applications/case/documentation-metadata/documentation-metadata.router.js';
import applicationsEditRouter from '@pins/appeals.web/src/server/applications/case/edit/applications-edit.router.js';
import { assertDomainTypeIsNotInspector } from '@pins/appeals.web/src/server/applications/create-new-case/applications-create.guards.js';
import asyncRoute from '@pins/appeals.web/src/server/lib/async-route.js';
